(function() {
    // Select the customer div element
    let customerDiv = document.getElementById('lynk-jediteck-customer');
  
    // Retrieve the key attribute value
    let key = customerDiv?.getAttribute('key');
  
    // Log the key value to the console
    ...
    container.innerHTML = `<iframe src="https://devlynkai.jediteck.com/chatbot?Key=${key}&domain=${currentDomain}" class="lynk-chatbot-frame" title="Chatbot"></iframe>`;
