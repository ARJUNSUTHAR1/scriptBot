                                ...
                                <div className="choose-layout flex items-center gap-2">
                                    ...
                                    >
                                        <div className='flex items-center gap-0.5'>
                                            <span className='w-[3px] h-4 bg-[#000] rounded-sm'></span>
                                            <span className='w-[3px] h-4 bg-[#000] rounded-sm'></span>
                                            <span className='w-[3px] h-4 bg-[#000] rounded-sm'></span>
                                        </div>
                                    </div>
                                    <div
                                        className={`item four-col p-2 border border-[#000] rounded flex items-center justify-center cursor-pointer ${layoutCol === 4 ? 'active' : ''}`}
