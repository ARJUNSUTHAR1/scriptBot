            ...
            <div className='faqs-block md:py-20 py-10'>
                <div className="container">
                    <div className="flex justify-between md:flex-row flex-col">
                        <div className="left md:w-1/4 mb-10  flex justify-center md:justify-start ">
                            <div className="menu-tab flex flex-col gap-5 icon  items-center md:items-start ">
                                {[
                        ...
                        <div className="right md:w-2/3 icon">
