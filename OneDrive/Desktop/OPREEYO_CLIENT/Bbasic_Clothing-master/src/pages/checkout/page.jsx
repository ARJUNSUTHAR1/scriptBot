                    ...
                    <div className="content-main flex flex-col-reverse md:flex-row justify-between">
                                    ...
                                    <form>
                                        <div className="grid sm:grid-cols-2 gap-4 gap-y-5 flex-wrap icon">
                                            ...
                                            <div className="col-span-full">
                                                <textarea className="border border-[#989797] px-4 py-3 w-full rounded-lg" id="note" name="note" placeholder="Write note..."></textarea>
                                            </div>
                                        </div>
                                        <div className="payment-block md:mt-10 mt-6">
                                            <div className="heading5 icon font-[800]">Choose payment Option:</div>
                                            <div className="list-payment mt-5 icon">
                                                <div className={`type bg-[#fcfafa] p-5 border border-[#989797] rounded-lg ${activePayment === 'credit-card' ? 'open' : ''}`}>
                                                ...
                                                <div className={`type bg-surface p-5 border border-[#989797] rounded-lg mt-5 ${activePayment === 'cash-delivery' ? 'open' : ''}`}>
                                        ...
                                        <div className="block-button md:mt-10 mt-6">
                                            <button className="button-main w-full icon font-[800]">Payment</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div className="right md:w-5/12">
                            <div className="checkout-block">
                                <div className="heading5 pb-3 icon font-[800]">Your Order</div>
