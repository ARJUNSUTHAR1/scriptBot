...
const Default = ({ data }) => {
    ...
    const handleSwiper = (swiper) => setThumbsSwiper(swiper)
                    ...
                    <div className="container flex justify-between gap-y-6 flex-wrap">
                        ...
                        <div className="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
                            <div className="flex justify-between">
                                <div>
                                    <div className="caption2 text-secondary font-semibold uppercase icon">{productMain.category}</div>
                            ...
                            <div className='desc text-secondary mt-3 icon'>{productMain.description}</div>
                            ...
                            <div className="get-it mt-6 pb-8 border-b border-line">
                                ...
                                <div className="item flex items-center gap-3 mt-4">
                                    <i className="fas fa-rotate-left text-4xl"></i>
                                    <div>
                ...
                <div className="review-block md:py-20 py-10 bg-surface">
                    <div className="container">
                        <div className="heading flex items-center justify-between flex-wrap gap-4">
                            ...
                            <Link to={'#form-review'} className='button-main bg-white text-black border border-black'>Write Reviews</Link>
                        </div>
                                ...
                                <div className="right lg:w-3/4 w-full lg:pl-[15px]">
                                    ...
                                    <div className="action mt-3">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <Link to={'#form-review'} className="reply-btn text-button text-secondary cursor-pointer hover:text-black">Reply</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
