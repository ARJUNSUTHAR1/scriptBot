    ...
    return (
        <>
            <div className="breadcrumb-block style-img">
                <div className="breadcrumb-main bg-right-bottom bg-[url(https://images.unsplash.com/photo-1577084392948-cfd46114098c?q=80&w=2064&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] bg-no-repeat bg-cover  overflow-hidden">
                    <div className="container lg:pt-[134px] pt-24 pb-10 relative">
                        <div className="main-content w-full h-full flex flex-col items-center justify-center relative z-[1]">
                            <div className="text-content">
                                <div className="heading2 text-center icon text-[#fff]">{dataType === null ? 'Shop' : dataType}</div>
                                <div className="link flex items-center justify-center gap-1 caption1 mt-3">
                                    <Link className='icon text-[#fff]' href={'/'}>Homepage</Link>
                                    <Icon.CaretRight size={14} className='text-secondary2 text-[#fff]' />
                                    <div className='text-secondary2 capitalize icon text-[#fff]'>{dataType === null ? 'Shop' : dataType}</div>
                                </div>
                            </div>
                            <div className="list-tab flex flex-wrap items-center justify-center gap-y-5 gap-8 lg:mt-[70px] mt-12 overflow-hidden">
                                {['t-shirt', 'dress', 'top', 'swimwear', 'shirt'].map((item, index) => (
                                    <div
                                        key={index}
                                        className={`tab-item text-button-uppercase icons cursor-pointer has-line-before line-2px ${dataType === item ? 'active' : ''} `}
                                    ...
                                    <div className="choose-layout flex items-center gap-2">
                                        ...
                                        <Link href={'/shop/sidebar-list'} className="item row w-8 h-8 border border-line rounded flex items-center justify-center cursor-pointer">
                                            <div className='flex flex-col items-center gap-0.5'>
                                                <span className='w-4 h-[3px] bg-[#000] rounded-sm'></span>
                                                <span className='w-4 h-[3px] bg-[#000] rounded-sm'></span>
                                                <span className='w-4 h-[3px] bg-[#000] rounded-sm'></span>
                                            </div>
                                        </Link>
